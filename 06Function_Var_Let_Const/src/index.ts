...

{
    ...
    const ifVariable3:number = 25;  // local variable
}
// console.log(ifVariable1); // output: 30
// console.log(ifVariable2); // error: Cannot find name 'ifVariable2'
// console.log(ifVariable3); // error: Cannot find name 'ifVariable3'
